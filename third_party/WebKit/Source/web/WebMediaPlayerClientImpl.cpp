...
void WebMediaPlayerClientImpl::load(WebMediaPlayer::LoadType loadType, const WTF::String& url, WebMediaPlayer::CORSMode corsMode)
{
    ...
    if (!WebCore::video_default_fullscreen || !m_webMediaPlayer.get()) {
        XLOGD(WebCore::HTML5, "WebMediaPlayerClientImpl::loadInternal - createWebMediaPlayer - create!");
        ...
        XLOGD(WebCore::HTML5, "WebMediaPlayerClientImpl::loadInternal - createWebMediaPlayer - skip");
    }
