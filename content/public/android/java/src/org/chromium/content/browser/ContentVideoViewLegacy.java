...
public class ContentVideoViewLegacy extends ContentVideoView {
    ...
    private static class FullScreenMediaController extends MediaController {
        ...
        public void show() {
            ...
            Log.d(LOGTAG, "FullScreenMediaController - show...");
        ...
        public void hide() {
            ...
            Log.d(LOGTAG, "FullScreenMediaController - hide...");
            if (mVideoView != null) {
    ...
    protected void showContentVideoView() {
        ...
        surfaceView.setOnKeyListener(new OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                Log.d(LOGTAG, "ContentVideoViewLegacy - onKey...   keyCode="+keyCode);
                ...
                if (isInPlaybackState() && isKeyCodeSupported && mMediaController != null) {
                    if (keyCode == KeyEvent.KEYCODE_HEADSETHOOK ||
                      ...
                      Log.d(LOGTAG, "ContentVideoViewLegacy - onKey(exitFullscreen)..."+keyCode);
        ...
        setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (isInPlaybackState() && mMediaController != null &&
                    ...
                    Log.d(LOGTAG, "ContentVideoViewLegacy - onTouch=ACTION_DOWN...");
                    toggleMediaControlsVisiblity();
                }
                return true;
            }
    ...
    private void toggleMediaControlsVisiblity() {
        ...
        Log.d(LOGTAG, "FullScreenMediaController - toggleMediaControlsVisiblity...");
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        Log.d(LOGTAG, "ContentVideoViewLegacy - onTouchEvent...");
        return true;
    }
