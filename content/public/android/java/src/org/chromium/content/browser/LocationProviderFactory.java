...
public class LocationProviderFactory {
    ...
    private static final String FAKE_MOCK_PROVIDER_NAME = "fake_provider";
    ...
    private static class LocationProviderImpl
        ...
        private void updateLocation(final double latitude, final double longitude) {
            updateLocation(FAKE_MOCK_PROVIDER_NAME, latitude, longitude);
        }
        ...
        private boolean usePassiveOneShotLocation() {
            ...
            /*if no location provider,should alway send the new location message*/
