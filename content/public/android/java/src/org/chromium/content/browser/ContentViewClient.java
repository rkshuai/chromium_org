...
public class ContentViewClient {
    ...
    public static boolean shouldPropagateKey(int keyCode) {
        if (keyCode == KeyEvent.KEYCODE_MENU ||
            ...
            keyCode == 2002 || //KeyEvent.KEYCODE_SOURCE for DPT
            keyCode == 2006 || //KeyEvent.KEYCODE_TVSETUP for DPT
            keyCode == 2005 || //KeyEvent.KEYCODE_ZOOM for DPT
            keyCode == 2000 || //KeyEvent.KEYCODE_PICTUREMODE for DPT
            keyCode == 2004 || //KeyEvent.KEYCODE_SOUNDMODE for DPT
