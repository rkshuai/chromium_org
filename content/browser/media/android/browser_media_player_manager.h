...
class CONTENT_EXPORT BrowserMediaPlayerManager
 ...
 public:
  ...
  // video output mode(Hiplayer use)
  enum VideoOutMode {
    VOUT_GRAPHIC,
    VOUT_VIDEO,
    VOUT_NULL,
 ...
 // get player total number
  ...
  void SetVideoOutMode(VideoOutMode Vmode);
  VideoOutMode GetVideoOutMode(void);
 ...
 private:
  ...
  //last video out mode
  VideoOutMode video_out_mode_last;
